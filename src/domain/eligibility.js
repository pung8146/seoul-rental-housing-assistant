...
const hasDifferentExplicitTarget = (profile, notice) => {
...
const getRequirementNumber = (requirements, key) => {
...
export const assessEligibility = (profile, notice) => {
    if (!profile) {
